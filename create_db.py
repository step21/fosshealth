...
for record in data:
    ...
    qr = f"""INSERT INTO repo_metadata (id, owner, repo_name, repo_stars, repo_forks, repo_watchers, is_fork, is_archived, languages, language_count, topics, topic_count, disk_usage_kb, pull_requests, issues, description, primary_language, created_at, pushed_at, default_branch_commit_count, assignable_user_count, code_of_conduct, forking_allowed, name_and_owner, parent) VALUES (number_records, '{record['owner']}', '{record['name']}', {record['stars']}, {record['forks']}, {record['watchers']}, {record['isFork']}, {record['isArchived']}, '{record['languages']}', {record['languageCount']}, '{record['topics']}', {record['topicCount']}, {record['diskUsageKb']}, {record['pullRequests']}, {record['issues']}, '{record['description']}', '{record['primary_language']}', '{record['createdAt']}', '{record['pushedAt']}', {record['defaultBranchCommitCount']}, '{record['assignableUserCount']}', '{record['codeOfConduct']}', {record['forkingAllowed']}, '{record['nameAndOwner']}', '{record['parent']}')"""
